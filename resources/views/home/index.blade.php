...
<body>
    ...
    <div class="app-container">
        ...
        <div class="main-area" id="main">
                ...
                <div class="access-links">
                    ...
                    <div class="access-link-wrapper">
                        <div class="access-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-music">
            ...
            <section class="content-section">
                <div class="section-header-wrapper">
                    <h1 class="section-header">Post Questions</h1>
                </div>
                <div class="files-table">
                    @include('home.addquestion')
                </div>
            </section>
            {{-- End Post Question --}}

            {{-- Start Post List Home --}}
            <section class="content-section">
                <div class="section-header-wrapper">
                    <h1 class="section-header">Question Highlight</h1>
                    <a class="section-header-link">
                        View all quesion
                    </a>
                </div>
                <div id="questionList">
                    {{-- @include('home.postlisthome') --}}
                </div>
            </section>
            <hr />
            {{-- End Post List Home --}}

            <div class="auto-load text-center" id="loading" style="text-align: center">
        ...
        <div class="right-area">
            ...
            <div class="right-area-header-wrapper">
                <p class="right-area-header">{{ Auth::user()->name }}</p>
            ...
            <div class="received-item-line">
                ...
                <div class="received-items-content">
                    ...
                    <div class="received-files-info">
                        Received <span class="info-purple">3 images</span> total <span class="info-purple">50.3
                            MB</span>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        mainArea.addEventListener("scroll", function() {
            if (mainArea.offsetHeight + mainArea.scrollTop >= mainArea.scrollHeight) {
                page++;
                getMore(page);
            }
        });
            ...
            $.ajax({
                ...
                .done(function(response) {
                    if (response.length < 10) {
                        loading.innerHTML = "We don't have more data to display :(";
                        return;
                    }
